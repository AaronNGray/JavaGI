...
public interface SortedMap<K,V,M> extends Map<K,V,M> {
    /**
     ...
     *	       <tt>null</tt> keys.
     */
    SortedMap<K,V,M> subMap(K fromKey, K toKey);
     ...
     */
    SortedMap<K,V,M> headMap(K toKey);
     ...
     *	       this sorted map does not tolerate <tt>null</tt> keys.
     */
    SortedMap<K,V,M> tailMap(K fromKey);
