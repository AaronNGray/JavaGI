    ...
    implements Map<K,V,Resizable>
{
    ...
    private abstract class LinkedHashIterator<T> implements Iterator<T,Resizable> {
    ...
    private class EntryIterator extends LinkedHashIterator<Map.Entry<K,V,Modifiable>> {
	public Map.Entry<K,V,Modifiable> next() { return nextEntry(); }
    }

    // These Overrides alter the behavior of superclass view iterator() methods
    Iterator<K,Resizable> newKeyIterator()   { return new KeyIterator();   }
    Iterator<V,Resizable> newValueIterator() { return new ValueIterator(); }
    Iterator<Map.Entry<K,V,Modifiable>,Resizable> newEntryIterator() { return new EntryIterator(); }
     ...
     */
    protected boolean removeEldestEntry(Map.Entry<K,V,Modifiable> eldest) {
        return false;
    }
}
