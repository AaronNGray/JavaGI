...
public interface Map<K,V,M> {
     ...
     *            <tt>null</tt>.
     */
     V put(K key, V value)where M extends Resizable;
     ...
     *         not supported by this map.
     */
    V remove(Object key) where M extends Shrinkable;
     ...
     */
    void putAll(Map<? extends K, ? extends V, ?> t)where M extends Resizable;
     ...
     */
    Set<K,Shrinkable> shrinkableKeySet() where M extends Shrinkable;
    Set<K,Modifiable> modifiableKeySet() where M extends Modifiable;
    Set<K,Object> keySet();
     ...
     */
    Collection<V, Shrinkable> shrinkableValues() where M extends Shrinkable;
    Collection<V, Modifiable> modifiableValues() where M extends Modifiable;
    Collection<V, Object> values();
     ...
     */
    Set<Map.Entry<K,V,M>,Shrinkable> shrinkableEntrySet() where M extends Shrinkable;
    Set<Map.Entry<K,V,M>,Modifiable> modifiableEntrySet() where M extends Modifiable;
    Set<Map.Entry<K,V,Object>,Object> entrySet();
	 ...
	 *	      <tt>null</tt>.
         ...
         *         removed from the backing map
         */
	V setValue(V value) where M extends Modifiable ;
