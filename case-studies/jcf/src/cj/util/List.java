...
public interface List<E,M> extends Collection<E,M> {
     ...
     *		  &lt; 0 || index &gt; size()).
     */
    boolean addAll(int index, Collection<? extends E,?> c) where M extends Resizable;
     ...
     *         &lt; 0 || index &gt; size()).
     */
    ListIterator<E,M> listIterator(int index);
     ...
     */
    List<E,M> subList(int fromIndex, int toIndex);
}
