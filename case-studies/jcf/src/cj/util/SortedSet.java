...
public interface SortedSet<E, M> extends Set<E, M> {
    /**
     ...
     */
    SortedSet<E, M> subSet(E fromElement, E toElement);
     ...
     */
    SortedSet<E, M> headSet(E toElement);
     ...
     *         specified range of the subSet, headSet, or tailSet.
     */
    SortedSet<E, M> tailSet(E fromElement);
