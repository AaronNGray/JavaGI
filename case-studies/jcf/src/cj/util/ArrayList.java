...
public class ArrayList<E,M> extends AbstractList<E,M>
    implements List<E,M>, RandomAccess, Cloneable, java.io.Serializable
{
    ...
    public Object clone() {
	try { 
	    ArrayList<E,M> v = (ArrayList<E,M>) super.clone();
     ...
     */
    private void fastRemove(int index) where M extends Shrinkable{
        modCount++;
        int numMoved = size - index - 1;
        if (numMoved > 0)
            System.arraycopy(elementData, index+1, elementData, index, 
