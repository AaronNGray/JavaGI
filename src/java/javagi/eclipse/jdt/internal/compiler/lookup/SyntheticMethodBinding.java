...
public class SyntheticMethodBinding extends MethodBinding {
	...
	*/
	...
	/**
	 * Synthetic methods for JavaGI.
	 */
	public SyntheticMethodBinding(ReferenceBinding declaringClass, char[] selector, TypeBinding returnType) {
	    this(declaringClass, selector, returnType, new TypeBinding[]{}, new ReferenceBinding[]{});
	}
	
	public SyntheticMethodBinding(ReferenceBinding declaringClass, char[] selector, TypeBinding returnType, 
	                              TypeBinding[] parameters, ReferenceBinding[] thrownExceptions) {
	    this.declaringClass = declaringClass;
	    this.selector = selector;
