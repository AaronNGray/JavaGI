...
public interface TypeConstants {
    ...
    char[] WILDCARD_IMPLEMENTS = " implements ".toCharArray(); //$NON-NLS-1$
    char[] WILDCARD_MINUS = { '-' };
    char[] WILDCARD_STAR = { '*' };
    char[] WILDCARD_PLUS = { '+' };
	...
	//SW: JavaGI support
	//////////////////////////////////////////////////////////////////////////////////////////////////
	char[] SYNTHETIC_JAVAGI_RECEIVER_ARG = "receiverArg-".toCharArray();
	char[] SYNTHETIC_JAVAGI_RECEIVER_LOCAL = "receiverLocal-".toCharArray();
}
