...
public abstract class Binding {
	...
	*/
	 ...
	 * @see javagi.eclipse.jdt.internal.compiler.lookup.SourceTypeBinding#getAnnotationTagBits()
	 */
	 ...
	 * @see javagi.eclipse.jdt.internal.compiler.lookup.SourceTypeBinding#initializeDeprecatedAnnotationTagBits()
	 */
	...
	*/
    ...
    public static final int CONSTRAINT = TYPE | ASTNode.Bit15;
    public static final ConstraintBinding[] NO_CONSTRAINTS = new ConstraintBinding[0];
    public static final LocalVariableBinding[] NO_LOCALS = new LocalVariableBinding[0];
    public static final ReferenceBinding[] NO_IMPL_TYPES = new ReferenceBinding[0];
    public static final ReferenceBinding[] NO_RECEIVERS = new ReferenceBinding[0];
