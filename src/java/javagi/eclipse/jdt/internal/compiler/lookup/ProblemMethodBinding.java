...
//SW: JavaGI support
//////////////////////////////////////////////////////////////////////////////////////////////////
private String javaGIMsg = null;
private Object[] javaGIMsgArgs = null;

public void reportJavaGIProblem(String errorMessage, Object... args) {
    if (errorMessage == null || args == null) throw new NullPointerException();
    this.javaGIMsg = errorMessage;
    this.javaGIMsgArgs = args;
}
public boolean isJavaGIProblem() {
    return javaGIMsg != null;
}
public String getJavaGIMessage() {
    return javaGIMsg;
}
public Object[] getJavaGIMessageArguments() {
    return javaGIMsgArgs;
}
}
