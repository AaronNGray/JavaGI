...
/**
 * @see javagi.eclipse.jdt.core.compiler.CategorizedProblem#getCategoryID()
 */
@Override
 ...
 * @see javagi.eclipse.jdt.core.compiler.IProblem#getID()
 * @return int
 */
public int getID() {
	return this.id;
 ...
 * @see javagi.eclipse.jdt.core.compiler.CategorizedProblem#getMarkerType()
 */
@Override
