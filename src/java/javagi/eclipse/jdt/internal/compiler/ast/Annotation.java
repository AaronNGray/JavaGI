...
public abstract class Annotation extends Expression {
    ...
    public TypeBinding resolveType(BlockScope scope) {
		...
		this.setResolvedType(typeBinding);
		...
		ReferenceBinding annotationType = (ReferenceBinding) this.getResolvedType();
...
//		if (scope.compilerOptions().storeAnnotations)
		this.compilerAnnotation = scope.environment().createAnnotation((ReferenceBinding) this.getResolvedType(), this.computeElementValuePairs());
