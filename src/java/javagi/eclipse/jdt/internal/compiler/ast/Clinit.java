...
import javagi.eclipse.jdt.internal.compiler.flow.ExceptionHandlingFlowContext;
...
import javagi.eclipse.jdt.internal.compiler.parser.Parser;
...
public class Clinit extends AbstractMethodDeclaration {
	 ...
	 */
	@Override
    public void generateCode(ClassScope classScope, ClassFile classFile, MethodPatch ignoredPatch) {
	...
	private void generateCode(
		...
		staticInitializerScope.computeLocalVariablePositions(DefaultMethodPatch.theInstance, 0, codeStream);
