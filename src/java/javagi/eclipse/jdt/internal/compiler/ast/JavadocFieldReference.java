...
public class JavadocFieldReference extends FieldReference {
	...
	*/
	...
	protected TypeBinding internalResolveType(Scope scope) {
		...
		if (!fieldBinding.isValidBinding() || !(fieldBinding instanceof FieldBinding)) {
			...
			if (this.receiverType instanceof ReferenceBinding) {
				...
				MethodBinding possibleMethod = this.receiver.isThis()
					? scope.getImplicitMethod(this.token, Binding.NO_TYPES, this, scope.getTypeEnvironment())
					: scope.getMethod(refBinding, this.token, Binding.NO_TYPES, this, scope.getTypeEnvironment());
		...
		return this.setResolvedType(this.binding.type);
	}
