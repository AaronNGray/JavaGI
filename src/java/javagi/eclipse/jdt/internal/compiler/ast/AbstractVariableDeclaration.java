...
public abstract class AbstractVariableDeclaration extends Statement implements InvocationSite {
	...
	/* (non-Javadoc)
	 * @see javagi.eclipse.jdt.internal.compiler.lookup.InvocationSite#isTypeAccess()
	 */
	...
	/* (non-Javadoc)
	 * @see javagi.eclipse.jdt.internal.compiler.lookup.InvocationSite#setActualReceiverType(javagi.eclipse.jdt.internal.compiler.lookup.ReferenceBinding)
	 */
	...
	/* (non-Javadoc)
	 * @see javagi.eclipse.jdt.internal.compiler.lookup.InvocationSite#setDepth(int)
	 */
	...
	/* (non-Javadoc)
	 * @see javagi.eclipse.jdt.internal.compiler.lookup.InvocationSite#setFieldIndex(int)
	 */
