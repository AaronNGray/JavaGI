...
public class ClassLiteralAccess extends Expression {
    ...
    public void generateCode(
		...
		if (valueRequired) {
			codeStream.generateClassLiteralAccessForType(type.getResolvedType(), syntheticField);
    ...
    public TypeBinding resolveType(BlockScope scope) {
		...
		if (classType.isGenericType()) {
			...
			this.setResolvedType(scope.environment().createParameterizedType(classType, new TypeBinding[]{ boxedType }, null/*not a member*/));
		} else {
			this.setResolvedType(classType);
		}
