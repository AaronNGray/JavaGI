		...
		if (returnTypeBinding != null) {
			...
			checkAnnotationMethodType: {
				...
				if (returnTypeBinding.dimensions() <= 1) { // only 1-dimensional array permitted
					switch (leafReturnType.erasure(scope.getTypeEnvironment()).id) {
						case T_byte :
						case T_short :
						case T_char :
						case T_int :
			...
			if (this.defaultValue != null) {
				...
				this.binding.setDefaultValue(javagi.eclipse.jdt.internal.compiler.lookup.ElementValuePair.getValue(this.defaultValue));
