 ...
 * javagi.eclipse.jdt.core.compiler public package where it is API. 
...
private int internalScanIdentifierOrKeyword(int index, int length, char[] data) {
	switch (data[index]) {
		...
		case 'i' : //if implements import instanceof int interface implementation
			switch (length) {
				case 2 :
					if (data[++index] == 'f')
						return TokenNameif;
				...
				case 14:
                    if (data[++index] == 'm')
                        if ((data[++index] == 'p')
                            ...
                            && (data[++index] == 'o')
                            && (data[++index] == 'n'))
                            return TokenNameimplementation;
                        else
                            return TokenNameIdentifier;				    
				default :
					return TokenNameIdentifier;
