...
import javagi.eclipse.jdt.internal.compiler.classfmt.ClassFormatException;
...
public class ArchiveFileObject implements JavaFileObject {
	...
	public CharSequence getCharContent(boolean ignoreEncodingErrors) throws IOException {
		if (getKind() == Kind.SOURCE) {
			return Util.getCharContents(this, ignoreEncodingErrors, javagi.eclipse.jdt.internal.compiler.util.Util.getZipEntryByteContent(this.zipEntry, this.zipFile), this.charset.toString());
		}
		return null;
	}
