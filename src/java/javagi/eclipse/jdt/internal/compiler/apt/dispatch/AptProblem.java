...
import javagi.eclipse.jdt.internal.compiler.problem.DefaultProblem;

public class AptProblem extends DefaultProblem {
	
	// The batch compiler does not depend on javagi.eclipse.jdt.apt.pluggable.core; this
	...
	// javagi.eclipse.jdt.apt.pluggable.core plug-in.
	private static final String MARKER_ID = "javagi.eclipse.jdt.apt.pluggable.core.compileProblem";  //$NON-NLS-1$
