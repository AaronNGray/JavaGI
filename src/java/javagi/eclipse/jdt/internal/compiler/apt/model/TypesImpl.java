...
//        throw new UnsupportedOperationException("NYI: TypesImpl.asMemberOf(" + containing + ", " + element + ")"); //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
    ...
    public TypeElement boxedClass(PrimitiveType p) {
        ...
        TypeBinding boxed = _env.getLookupEnvironment().computeBoxingType(null, baseTypeBinding);
    ...
    public TypeMirror erasure(TypeMirror t) {
        ...
        Binding binding = typeMirrorImpl._binding;
        if (binding instanceof ReferenceBinding) {
            return _env.getFactory().newTypeMirror(((ReferenceBinding) binding).erasure((TypeEnvironment) null));
        }
    ...
    public boolean isAssignable(TypeMirror t1, TypeMirror t2) {
        ...
        if (((TypeBinding)b1).isCompatibleWith((javagi.compiler.TypeEnvironment) null, (TypeBinding)b2)) {
            return true;
        }

        TypeBinding convertedType = _env.getLookupEnvironment().computeBoxingType(null, (TypeBinding)b1);
        return null != convertedType && convertedType.isCompatibleWith((javagi.compiler.TypeEnvironment) null, (TypeBinding)b2);
    }
    ...
    public boolean isSubtype(TypeMirror t1, TypeMirror t2) {
        ...
        if (b1.kind() == Binding.BASE_TYPE || b2.kind() == Binding.BASE_TYPE) {
            if (b1.kind() != b2.kind()) {
                ...
                return ((TypeBinding)b1).isCompatibleWith((javagi.compiler.TypeEnvironment) null, (TypeBinding)b2);
            }
        }
    ...
    public PrimitiveType unboxedType(TypeMirror t) {
        ...
        TypeBinding unboxed = _env.getLookupEnvironment().computeBoxingType(null, boxed);
