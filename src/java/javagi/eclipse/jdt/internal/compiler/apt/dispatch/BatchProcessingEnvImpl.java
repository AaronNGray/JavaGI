...
import javagi.eclipse.jdt.internal.compiler.apt.util.EclipseFileManager;
 ...
 * @see javagi.eclipse.jdt.internal.apt.pluggable.core.dispatch.IdeProcessingEnvImpl
 */
public class BatchProcessingEnvImpl extends BaseProcessingEnvImpl {
			...
			String[] commandLineArguments)
	{
		...
		Class<?> c = null;
		try {
			c = Class.forName("javagi.eclipse.jdt.internal.compiler.tool.EclipseCompilerImpl"); //$NON-NLS-1$
