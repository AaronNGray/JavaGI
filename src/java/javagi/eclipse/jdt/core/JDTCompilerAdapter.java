 ...
 *******************************************************************************/
package javagi.eclipse.jdt.core;
...
import javagi.eclipse.jdt.internal.antadapter.AntAdapterMessages;
 ...
 * <p>
 * <code>&lt;property name="build.compiler" value="javagi.eclipse.jdt.core.JDTCompilerAdapter"/&gt;</code>
 * </p>
 * <p>
...
public class JDTCompilerAdapter extends DefaultCompilerAdapter {
	...
	private static String compilerClass = "javagi.eclipse.jdt.internal.compiler.batch.Main"; //$NON-NLS-1$
	String logFileName;
    ...
    protected Commandline setupJavacCommand() throws BuildException {
       ...
       /*
		 ...
		 */
		if (this.attributes.getNowarn() || "1".equals(System.getenv("JAVAGIC_ANT_NOWARNINGS"))) {
