...
public class Launcher {
     ...
     */
    static class AppClassLoader extends URLClassLoader implements CustomClassLoader {

        public static AppClassLoader getAppClassLoader(final ExtClassLoader extcl)
        throws IOException
        {
            /*
            System.out.println("in AppClassLoader. CustomClassLoader = " + CustomClassLoader.class
        ...
        private ExtClassLoader extClassLoader;
        private ClassLoadingListener listener;
        private Vector cache;
         ...
         */
        AppClassLoader(URL[] urls, ExtClassLoader parent) {
            super(urls, parent, factory);
            this.extClassLoader = parent;
            this.cache = new Vector();
        }

        public void setClassLoadingListener(ClassLoadingListener l) {
            this.listener = l;
            this.extClassLoader.setClassLoadingListener(l);
            Iterator it = this.cache.iterator();
            while (it.hasNext()) {
                Class cls = (Class) it.next();
                this.listener.addClass(cls);
    ...
    {
        if ("javagi.runtime.ClassLoadingListener".equals(name)) return ClassLoadingListener.class;
        if ("javagi.runtime.CustomClassLoader".equals(name)) return CustomClassLoader.class;
